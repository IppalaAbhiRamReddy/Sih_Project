 ...
 * 
 * Custom dropdown picker with label support and searchable options.
 * Handles click-outside to close and provides a stylized alternative to browser defaults.
 */
