    ...
    return (
        <div className="min-h-screen bg-white font-sans">
            ...
            <header className="border-b border-gray-100 sticky top-0 bg-white/95 backdrop-blur-sm z-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-base sm:text-xl font-bold text-gray-900 tracking-tight line-clamp-2 sm:line-clamp-none">Digital Health Care Record System</span>
                    </div>
                    <button
                        onClick={handleLogin}
                        data-slot="button"
                        className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 h-9 py-2 bg-blue-600 hover:bg-blue-700 text-white px-4 sm:px-6 cursor-pointer"
                    >
                        Login
                    </button>
                </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl p-6 sm:p-8 md:p-12 shadow-sm border border-blue-100">
                    <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-8 sm:mb-12 text-center">Key Benefits</h2>
            ...
            <footer className="border-t border-gray-200 bg-gray-50 py-8 mt-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-8 text-center text-gray-600">
